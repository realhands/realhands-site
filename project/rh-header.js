...
(function () {
  var css = [
    ...
    ".rh-header-slot .rhh__nav{display:flex; align-items:center; gap:clamp(16px,2vw,26px); font-family:'IBM Plex Mono',ui-monospace,monospace; font-size:11px; letter-spacing:.08em; text-transform:uppercase;}",
