...
(function () {
  var css = [
    ...
    '.rh-header-slot .rhh__pill{padding:10px 18px; border-radius:999px; background:var(--rh-yellow,#EDE94D); color:#151310 !important; font-weight:600; display:inline-flex; align-items:center; box-shadow:inset 0 1px 0 rgba(255,255,255,.75); transition:transform .15s ease, filter .15s ease;}',
