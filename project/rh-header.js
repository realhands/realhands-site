...
(function () {
  var css = [
    ...
    '.rh-header-slot .rhh__pill{padding:10px 18px; border-radius:999px; background:var(--rh-yellow,#C9D14E); color:#151310 !important; font-weight:600; display:inline-flex; align-items:center; box-shadow:inset 0 1px 0 rgba(255,255,255,.75); transition:transform .15s ease, filter .15s ease;}',
    '.rh-header-slot .rhh__pill:hover{color:#151310 !important; transform:translateY(-1px); filter:brightness(1.05);}',
    '.rh-header-slot .rhh a.rhh__pill--current{box-shadow:none !important; background:transparent !important; text-decoration:underline; text-underline-offset:4px; text-decoration-thickness:1.5px; transform:none !important; filter:none !important;}',
    ...
    '.rh-header-slot[data-theme="light"] .rhh a:hover{color:var(--rh-yellow,#C9D14E);}',
    ...
    'html.rh-dark-zone .rh-header-slot .rhh a:hover{color:var(--rh-yellow,#C9D14E);}',
